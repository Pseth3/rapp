...
def ueA1():
    ...
    sleep(SLEEPINT)
    print("binding ue 101010123456789 to slice2")
    # curl -i -X POST http://${NEXRAN_XAPP}:8000/v1/slices/fast/ues/101010123456789
    res = request("POST","http://{}:8000/v1/slices/slice2/ues/101010123456789".format(NEXRAN_XAPP))
    sleep(SLEEPINT)
...
def ueA2():
    ...
    sleep(SLEEPINT)
    print("binding ue 101010123456787 to slice1 slice")
    # curl -i -X POST http://${NEXRAN_XAPP}:8000/v1/slices/slice1/ues/101010123456789
    res = request("POST","http://{}:8000/v1/slices/slice1/ues/101010123456787".format(NEXRAN_XAPP))
    sleep(SLEEPINT)
