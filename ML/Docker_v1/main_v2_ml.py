...
def put_policy(thread_id, ric_name, update_value=0):
    ...
    if (datetime.now()-initial_time).seconds > 90 and (datetime.now()-initial_time).seconds <=180:
        pol = 1
        I = 1
        print("Implementing policy 1")
    elif (datetime.now()-initial_time).seconds > 180 and (datetime.now()-initial_time).seconds <= 270:
        pol = 2
        I = 2
        print("Implementing policy 2")
    elif (datetime.now()-initial_time).seconds > 270 and (datetime.now()-initial_time).seconds <= 360:
        pol = 3
        I = 3
